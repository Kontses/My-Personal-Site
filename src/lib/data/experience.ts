...
export const items: Array<Experience> = [
	...
	},
	{
		...
		company: 'Traxis Engineering',
		description:
			"The ATS Support Engineer is a full-time role based for the Metro of Thessaloniki. Daily tasks include supporting the Automatic Train Supervision (ATS) systems, troubleshooting technical problems, carrying out system maintenance and ensuring the smooth operation of the railway systems at Metro's Operations Control Centre (OCC).",
		contract: ContractType.Contract,
		...
		logo: Assets.Traxis,
		shortDescription:
			'Support Engineer for Automatic Train Supervision (ATS) system at Metro of Thessaloniki.'
	},
	{
